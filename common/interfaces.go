...
// 	BlockByHash(ctx context.Context, hash Hash) (*types.Block, error)
// 	BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error)
// 	HeaderByHash(ctx context.Context, hash Hash) (*types.Header, error)
// 	HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error)
// 	TransactionCount(ctx context.Context, blockHash Hash) (uint, error)
// 	TransactionInBlock(ctx context.Context, blockHash Hash, index uint) (*types.Transaction, error)
...
// 	// it's not pending.
// 	TransactionByHash(ctx context.Context, txHash Hash) (tx *types.Transaction, isPending bool, err error)
// 	// TransactionReceipt returns the receipt of a mined transaction. Note that the
// 	// transaction may not be included in the current canonical chain even if a receipt
// 	// exists.
// 	TransactionReceipt(ctx context.Context, txHash Hash) (*types.Receipt, error)
// }
